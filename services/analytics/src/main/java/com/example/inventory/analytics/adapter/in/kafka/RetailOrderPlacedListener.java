...
/** {@code retail.order.placed.v1} を購読して analytics 集計に取り込む。 */
@Component
public class RetailOrderPlacedListener {

    private static final Logger LOG = LoggerFactory.getLogger(RetailOrderPlacedListener.class);
    ...
    public RetailOrderPlacedListener(IngestOrderPlacedUseCase useCase, ObjectMapper objectMapper) {
    ...
    @KafkaListener(
            ...
            groupId = "${spring.application.name}-retail-order")
