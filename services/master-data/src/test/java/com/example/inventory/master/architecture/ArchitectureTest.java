package com.example.inventory.master.architecture;
...
@AnalyzeClasses(
        packages = "com.example.inventory.master",
...
class ArchitectureTest {
    ...
    /**
     * ADR-0008 J-SOX 補完策 opt-in。 master-data の 3 write 系 (CreateSku/Location/Partner) は全て
     * {@code @Auditable} 付与済。 Get 系 3 つは read-only で対象外。
     */
    @ArchTest
