...
| Retail/EC (取消) | `retail.order.cancelled.v1` | release(明細毎、reserved → available) | (補償なし、DLQ) |
...
| Wholesale (取消) | `wholesale.order.cancelled.v1` | release(明細毎、reserved → available) | (補償なし、DLQ) |
