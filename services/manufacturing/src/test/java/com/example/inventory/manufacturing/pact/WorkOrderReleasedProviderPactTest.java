...
/** Provider 側 Pact verifier — {@code manufacturing.work_order.released.v1}(ADR-0019 Phase 2.2)。 */
...
public class WorkOrderReleasedProviderPactTest {
    ...
    public MessageAndMetadata workOrderReleasedV1Message() {
        ...
        WorkOrderReleasedEvent event =
                new WorkOrderReleasedEvent(
                        ...
                        // (Phase 3 の Pact Broker 連携時に matching rule を明示的に flexible 化する)
